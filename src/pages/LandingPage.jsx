                ...
                {extendedClinics.map((clinic, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl border transition-all ${hasActiveToken
                    ...
                    >
                      <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                        <div
                          className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${hasActiveToken ? 'bg-marigold animate-pulse' : 'bg-sandstone'
                            }`}
                        ></div>
                        <div className="min-w-0">
                          <p className={`text-sm sm:text-base font-bold truncate ${hasActiveToken ? 'text-teak' : 'text-khaki'
                            }`}>
                            {clinic.name}
                          </p>
